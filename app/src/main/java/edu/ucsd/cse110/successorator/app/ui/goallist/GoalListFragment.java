...
import edu.ucsd.cse110.successorator.app.ui.goallist.dialog.ConfirmDeleteCardDialogFragment;
...
//        view..setAdapter(adapter);
        view.finishedList.setAdapter(adapter);
        view.unfinishedList.setAdapter(adapter);
